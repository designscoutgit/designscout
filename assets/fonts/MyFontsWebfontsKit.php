...
/*
Plugin Name: MyFontsWebfontsKit #852363
...
add_action( 'admin_init', array('MonotypeInstaller_852363','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MonotypeInstaller_852363','monotype_loadupWebfonts' ));
